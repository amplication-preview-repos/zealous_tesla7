...
@InputType()
class ShippingUpdateInput {
  @ApiProperty({
    required: false,
    type: () => DeliveryUpdateManyWithoutShippingsInput,
  })
  @ValidateNested()
  @Type(() => DeliveryUpdateManyWithoutShippingsInput)
  @IsOptional()
  @Field(() => DeliveryUpdateManyWithoutShippingsInput, {
    nullable: true,
  })
...
export { ShippingUpdateInput as ShippingUpdateInput };
