...
@InputType()
class DeliveryCreateNestedManyWithoutShippingsInput {
...
export { DeliveryCreateNestedManyWithoutShippingsInput as DeliveryCreateNestedManyWithoutShippingsInput };
