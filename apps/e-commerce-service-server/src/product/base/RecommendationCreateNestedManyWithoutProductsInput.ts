...
@InputType()
class RecommendationCreateNestedManyWithoutProductsInput {
...
export { RecommendationCreateNestedManyWithoutProductsInput as RecommendationCreateNestedManyWithoutProductsInput };
