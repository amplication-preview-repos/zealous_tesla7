...
const service = {
  ...
  contentManagements: () => FIND_MANY_RESULT,
  contentManagement: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("ContentManagement", () => {
  ...
  test("POST /contentManagements", async () => {
    await request(app.getHttpServer())
      .post("/contentManagements")
      .send(CREATE_INPUT)
  ...
  test("GET /contentManagements", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /contentManagements/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/contentManagements"}/${nonExistingId}`)
  ...
  test("GET /contentManagements/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/contentManagements"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /contentManagements existing resource", async () => {
