...
@InputType()
class RecommendationCreateNestedManyWithoutUsersInput {
...
export { RecommendationCreateNestedManyWithoutUsersInput as RecommendationCreateNestedManyWithoutUsersInput };
